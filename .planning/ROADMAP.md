...
Plans:
- [ ] 03-01: Public portal page — Leaflet ReportingMap, Nominatim address search, category picker, description field, anon logic
- [ ] 03-02: Ticket submission API (`POST /api/tickets`), media upload (bytea), Person auto-create, confirmation page
- [ ] 03-03: Public ticket detail page (`/tickets/[id]`), public-map endpoint, PublicMap component with markercluster
